...
const Dashboard = ({ user, onViewProposal }) => {
  ...
  switch (dashboardType) {
    case 'admin':
      return <AdminOverviewDashboard user={user} onViewProposal={onViewProposal} />;
    
    case 'society':
      return <SocietyDashboard user={user} onViewProposal={onViewProposal} />;
